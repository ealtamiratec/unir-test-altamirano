...
test-api:
	...
	docker run -d --rm --volume `pwd`:/opt/calc --network calc-test-api --env PYTHONPATH=/opt/calc --name apiserver --env FLASK_APP=app/api.py -p 5003:5000 -w /opt/calc calculator-app:latest flask run --host=0.0.0.0
